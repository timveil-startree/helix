  ...
  protected void bark() {
    ...
    if (shouldIntroduceError()) {
      try {
        ...
        LOG.debug(Thread.currentThread().getName() + " intentionally deleted an invalid path" + " at time: " + System.currentTimeMillis() );
      }
    } else {
      LOG.debug(Thread.currentThread().getName() + " is attempting to delete node: " + randomNumber + " at time: " + System.currentTimeMillis());
      if (_metaclient.delete(_parentPath + "/" + randomNumber)) {
        LOG.debug(Thread.currentThread().getName() + " successfully deleted node " + randomNumber + " at time: " + System.currentTimeMillis());
        ...
        LOG.debug(Thread.currentThread().getName() + " failed to delete node " + randomNumber + " at time: " + System.currentTimeMillis() + ", it does not exist");
      }
    }
  }
