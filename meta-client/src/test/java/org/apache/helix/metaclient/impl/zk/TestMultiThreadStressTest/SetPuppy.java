  ...
  protected void bark() {
    ...
    if (shouldIntroduceError()) {
      try {
        ...
        LOG.debug(Thread.currentThread().getName() + " intentionally called set on an invalid path" + " at time: " + System.currentTimeMillis());
      }
    } else {
      try {
        LOG.debug(Thread.currentThread().getName() + " is attempting to set node: " + randomNumber + " at time: " + System.currentTimeMillis());
        ...
        LOG.debug(Thread.currentThread().getName() + " failed to set node " + randomNumber + " at time: " + System.currentTimeMillis() + ", it does not exist");
      }
    }
  }
