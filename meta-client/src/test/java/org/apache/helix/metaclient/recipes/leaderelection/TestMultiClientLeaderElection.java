...
public class TestMultiClientLeaderElection extends ZkMetaClientTestBase {
  ...
  @BeforeTest
  private void setUp() {
    LOG.debug("STARTING TestMultiClientLeaderElection");
  ...
  public void testLeaderElectionPuppy() {
    LOG.debug("Starting TestMultiClientLeaderElection.testLeaderElectionPuppy");
    PuppySpec puppySpec =
    ...
    LOG.debug("Ending TestMultiClientLeaderElection.testLeaderElectionPuppy");
