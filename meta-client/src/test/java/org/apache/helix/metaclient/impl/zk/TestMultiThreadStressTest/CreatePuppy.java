  ...
  protected void bark() {
    ...
    if (shouldIntroduceError()) {
      try {
        ...
        LOG.debug(Thread.currentThread().getName() + " tried to create an invalid path" + " at time: " + System.currentTimeMillis());
        // Expected exception
      }
    } else {
      // Normal behavior - create a new node
      try {
        LOG.debug(Thread.currentThread().getName() + " is attempting to create node: " + randomNumber + " at time: " + System.currentTimeMillis());
        _metaclient.create(_parentPath + "/" + randomNumber,"test");
        LOG.debug(Thread.currentThread().getName() + " successfully created node " + randomNumber + " at time: " + System.currentTimeMillis());
        ...
        // Expected exception
        LOG.debug(Thread.currentThread().getName() + " failed to create node " + randomNumber + " at time: " + System.currentTimeMillis() + ", it already exists");
      }
    }
  }
