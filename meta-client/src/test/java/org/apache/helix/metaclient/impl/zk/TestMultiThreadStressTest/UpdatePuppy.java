  ...
  protected void bark() throws Exception {
    ...
    if (shouldIntroduceError()) {
      try {
        ...
        LOG.debug(Thread.currentThread().getName() + " intentionally tried to update an invalid path" + " at time: " + System.currentTimeMillis());
      }
    } else {
      try {
        LOG.debug(Thread.currentThread().getName() + " is attempting to update node: " + randomNumber + " at time: " + System.currentTimeMillis());
        ...
        LOG.debug(Thread.currentThread().getName() + " successfully updated node " + randomNumber + " at time: "
            + System.currentTimeMillis());
      } catch (MetaClientNoNodeException e) {
        LOG.debug(Thread.currentThread().getName() + " failed to update node " + randomNumber + " at time: " + System.currentTimeMillis() + ", it does not exist");
      } catch (IllegalArgumentException e) {
