...
public class MockCloudEventAwareHelixManager implements HelixManager {
  protected static final Logger LOG = LoggerFactory.getLogger(MockCloudEventAwareHelixManager.class);
  ...
  public void connect()
    ...
    if (_helixManagerProperty != null) {
      ...
      if (helixCloudProperty != null && helixCloudProperty.isCloudEventCallbackEnabled()) {
        ...
        LOG.debug("Using handler: " + helixCloudProperty.getCloudEventHandlerClassName());
  ...
  public void disconnect() {
    if (_cloudEventListener != null) {
      try {
        ...
        LOG.debug("Failed to unregister cloudEventListener." );
        e.printStackTrace();
      }
    }
  }
