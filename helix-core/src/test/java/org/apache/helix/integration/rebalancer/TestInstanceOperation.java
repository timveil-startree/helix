...
public class TestInstanceOperation extends ZkTestBase {
  ...
  public void testEvacuate() throws Exception {
    LOG.debug("START TestInstanceOperation.testEvacuate() at " + new Date(System.currentTimeMillis()));
  ...
  public void testRevertEvacuation() throws Exception {
    LOG.debug("START TestInstanceOperation.testRevertEvacuation() at " + new Date(System.currentTimeMillis()));
  ...
  public void testAddingNodeWithEvacuationTag() throws Exception {
    LOG.debug("START TestInstanceOperation.testAddingNodeWithEvacuationTag() at " + new Date(System.currentTimeMillis()));
  ...
  public void testEvacuateAndCancelBeforeBootstrapFinish() throws Exception {
    LOG.debug("START TestInstanceOperation.testEvacuateAndCancelBeforeBootstrapFinish() at " + new Date(System.currentTimeMillis()));
  ...
  public void testEvacuateAndCancelBeforeDropFinish() throws Exception {
    LOG.debug("START TestInstanceOperation.testEvacuateAndCancelBeforeDropFinish() at " + new Date(System.currentTimeMillis()));
  ...
  public void testMarkEvacuationAfterEMM() throws Exception {
    LOG.debug("START TestInstanceOperation.testMarkEvacuationAfterEMM() at " + new Date(System.currentTimeMillis()));
  ...
  public void testEvacuationWithOfflineInstancesInCluster() throws Exception {
    LOG.debug("START TestInstanceOperation.testEvacuationWithOfflineInstancesInCluster() at " + new Date(System.currentTimeMillis()));
    ...
    for (String db : _allDBs) {
      ...
      for (String partition : is.getPartitionSet()) {
        ...
        if (newPAssignedParticipants.contains(evacuateInstanceName)) {
          LOG.debug("partition " + partition + " assignment " + newPAssignedParticipants + " ev " + evacuateInstanceName);
          return false;
        }
      }
    }
