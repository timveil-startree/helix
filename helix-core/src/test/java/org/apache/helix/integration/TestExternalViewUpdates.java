...
public class TestExternalViewUpdates extends ZkTestBase {
  ...
  public void testExternalViewUpdates() throws Exception {
    LOG.debug("START testExternalViewUpdates at " + new Date(System.currentTimeMillis()));
    ...
    LOG.debug("END testExternalViewUpdates at " + new Date(System.currentTimeMillis()));
  }
}
