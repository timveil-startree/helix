...
public class TestClusterVerifier extends ZkUnitTestBase {
  ...
  public void testDisablePartitionAndStopInstance() throws Exception {
    ...
    try (BestPossibleExternalViewVerifier bestPossibleVerifier =
    ...
    try (StrictMatchExternalViewVerifier strictMatchVerifier =
  ...
  public void testResourceSubset() throws InterruptedException {
    ...
    try (StrictMatchExternalViewVerifier verifier = new StrictMatchExternalViewVerifier.Builder(_clusterName).setZkClient(_gZkClient)
