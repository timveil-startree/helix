...
public class BaseStageTest {
  ...
  protected static final Logger LOG = LoggerFactory.getLogger(BaseStageTest.class);
  ...
  public void beforeClass() {
    ...
    LOG.debug("START " + className.substring(className.lastIndexOf('.') + 1) + " at "
  ...
  public void afterClass() {
    String className = this.getClass().getName();
    LOG.debug("END " + className.substring(className.lastIndexOf('.') + 1) + " at "
        + new Date(System.currentTimeMillis()));
  }
  ...
  public void beforeTest(Method testMethod, ITestContext testContext){
    ...
    LOG.debug("START " + testMethod.getName() + " at " + new Date(startTime));
  ...
  public void endTest(Method testMethod, ITestContext testContext) {
    ...
    LOG.debug("END " + testMethod.getName() + " at " + new Date(endTime) + ", took: " + (endTime - startTime) + "ms.");
  }
