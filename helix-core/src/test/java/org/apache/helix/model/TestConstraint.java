...
public class TestConstraint extends ZkUnitTestBase {
  ...
  public void testMsgConstraint() {
    ...
    LOG.debug("START testMsgConstraint() at " + new Date(System.currentTimeMillis()));
    ...
    LOG.debug(msg1 + " matches(" + matches.size() + "): " + matches);
    ...
    LOG.debug(msg2 + " matches(" + matches.size() + "): " + matches);
    Assert.assertEquals(matches.size(), 5);
    Assert.assertTrue(contains(matches, constraint0));
    Assert.assertTrue(contains(matches, constraint1));
    Assert.assertTrue(contains(matches, constraint2));
    ...
    LOG.debug("END testMsgConstraint() at " + new Date(System.currentTimeMillis()));
  }

  @Test
  public void testStateConstraint() {
    String className = getShortClassName();
    LOG.debug("START testStateConstraint() at " + new Date(System.currentTimeMillis()));
    ...
    LOG.debug(stateAttr1 + " matches(" + matches.size() + "): " + matches);
    ...
    LOG.debug(stateAttr2 + " matches(" + matches.size() + "): " + matches);
    Assert.assertEquals(matches.size(), 2);
    Assert.assertTrue(contains(matches, constraint0));
    Assert.assertTrue(contains(matches, constraint2));
    ...
    LOG.debug("END testStateConstraint() at " + new Date(System.currentTimeMillis()));
  }
